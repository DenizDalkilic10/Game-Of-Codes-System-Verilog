...
HD_PWD='C:/Users/ASTOD/Desktop/CS223/Project/lab_project/lab_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gameController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gameController.tcl -notrace
