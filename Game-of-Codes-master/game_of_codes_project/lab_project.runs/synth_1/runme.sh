...
HD_PWD='C:/Users/ASTOD/Desktop/CS223/Project/lab_project/lab_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gameController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gameController.tcl
